...
use druid::widget::{Flex, Label, TextBox, Stepper, ViewSwitcher};
use druid::{
...
fn build_root_widget() -> impl Widget<RotatedState> {
    ...
    let rotated_part = ViewSwitcher::new( |rs:&RotatedState, _: &Env|{ rs.turns as u8 }, |turns: &u8, _: &RotatedState, _: &Env|{
    ...
    let row = Flex::row()
        ...
        .with_child(Label::new( |data: &f64, _env: &_| format!("Quarter turns: {}", *data as u8)  ))
